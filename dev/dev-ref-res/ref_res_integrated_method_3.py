...
class RefcocoDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, refer, tokenizer, errors, split='', max_bb = 15):
...
class RefcocoDataModule(LightningDataModule):
    def __init__(self, config, refer, errors, collate_fn, max_bb=15):
        super().__init__()
...
errors_list = errors_df['Sent ID'].to_list()
max_bb = 15
dm = RefcocoDataModule(config, refer, errors_list, collate_fn, max_bb=max_bb)
