...
The code is based on [ViLT](https://github.com/dandelin/ViLT) and [METER](https://github.com/zdou0830/METER) licensed under [Apache 2.0](https://github.com/dandelin/ViLT/blob/master/LICENSE) and [Apache.20](https://github.com/zdou0830/METER/blob/main/LICENSE) and also borrows heavily from the Hugging Face model hub.
