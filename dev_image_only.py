...
class Cifar10Dataset(torch.utils.data.Dataset):
    def __init__(self, split, processor):
        ...
        self.data = load_dataset('cifar10', split=split)#.to_dict()
    ...
    def __getitem__(self, index):
        ...
        image = self.transform(feature['img'])
        image = self.processor(image, do_rescale=False, return_tensors='pt')
...
class Cifar10DataModule(LightningDataModule):
    def __init__(self, config, batch_size=32, eval_batch_size=8):
        super().__init__()
    ...
    def set_train_dataset(self):
        self.train_dataset = Cifar10Dataset('train', self.processor)

    def set_val_dataset(self):
        self.val_dataset =  Cifar10Dataset('test', self.processor)

    def set_test_dataset(self):
         self.text_dataset = Cifar10Dataset('test', self.processor)
...
grad_steps = max(_config["batch_size"] // (
    _config["per_gpu_batchsize"] * num_gpus * config["num_nodes"]
), 1)
