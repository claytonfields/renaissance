...
def config():
    ...
    # Cross-Attention Layer Settings
    num_cross_layer = 6
    cross_layer_hidden_size = 256
    cross_layer_num_heads = 4
    # num_layers = 6
...
# ===================== Task Settings ===================== #
@ex.named_config
def task_mlm_itm_whole_word_masking():
    exp_name = "mlm_itm"
    # datasets = ["coco", "vg", "sbu", "gcc"]
    datasets = ["coco", "vg"]
    loss_names = _loss_names({"itm": 1, "mlm": 1})
...
def swinv2_base_patch4_window8_256():
    vit = "microsoft/swinv2-base-patch4-window8-256"
...
@ex.named_config
def swin_base_patch4_window_384_in22k():
    vit = "microsoft/swin-base-patch4-window12-384-in22k"
    patch_size = 4
    image_size = 384
    train_transform_keys = ["imagenet"]
    val_transform_keys = ["imagenet"]
...
@ex.named_config
def swin32_large_patch4_window12_384_in22k():
    vit = "microsoft/swin-large-patch4-window12-384-in22k"
    patch_size = 32
    image_size = 384
    train_transform_keys = ["imagenet"]
    val_transform_keys = ["imagenet"]
...
def swin_tiny_patch4_window7_224():
    vit = "microsoft/swin-tiny-patch4-window7-224"
    patch_size = 4
    image_size = 224
    train_transform_keys = ["imagenet"]
    val_transform_keys = ["imagenet"]
...
def deit_tiny_distilled_patch16_224():    
    vit = "facebook/deit-tiny-distilled-patch16-224"
    image_encoder_hidden_size = 192
    resolution_before = 224
    patch_size = 16
    train_transform_keys = ["imagenet"]
...
def deit_small_distilled_patch16_224():    
    vit = "facebook/deit-small-distilled-patch16-224"
    image_encoder_hidden_size = 384
    image_size = 224
    resolution_before = 224
    patch_size = 16
...
def deit_base_patch16_224():    
    vit = "facebook/deit-base-patch16-224"
    image_encoder_hidden_size = 768
    image_size = 224
    resolution_before = 224
    patch_size = 16
...
def deit_base_distilled_patch16_224():    
    vit = "facebook/deit-base-distilled-patch16-224"
    image_encoder_hidden_size = 768
    image_size = 224
    resolution_before = 224
    patch_size = 16
